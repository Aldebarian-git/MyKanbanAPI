...
const studentsList  = await List.create({ title: "Liste des apprennants", position: 2 });
const birthdaysList = await List.create({ title: "Liste des anniversaires", position: 3 });
